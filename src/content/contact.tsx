...
export const CONTACT_FORM = {
  ...
  form: {
    ...
    serviceOptions: [
      ...
      { label: "Event Lead Generation", value: "event-lead-generation" },
      { label: "Industry Events", value: "industry-events" },
      ...
      { label: "Video Editing Services", value: "video-editing-services" },
      ...
      { label: "LinkedIn Ads for B2B", value: "linkedin-ads" },
