  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        ...
        <h3 className="mb-4 line-clamp-2 min-h-[3.5rem] font-heading text-xl leading-tight font-bold md:text-2xl">
          {blog.title}
        </h3>
        {blog.excerpt && (
  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-md transition-shadow duration-300 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="mb-3 font-heading text-xl leading-snug font-bold md:text-2xl">
          {blog.title}
        </h3>
        {blog.excerpt && (
