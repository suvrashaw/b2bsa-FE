...
const FAQ_IMAGES: string[] = [
  ...
  "/images/services/database-research-1.avif",
  "/images/services/database-research-revised.avif",
  "/images/services/market-intelligence.avif",
  "/images/services/media-production-1.avif",
  "/images/services/media-production-2.avif",
  "/images/services/performance-marketing-1.avif",
  "/images/services/performance-marketing.avif",
  "/images/services/sql-generation-1.avif",
  "/images/services/sql-generation-2.avif",
