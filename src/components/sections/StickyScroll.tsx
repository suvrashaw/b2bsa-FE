...
const ReasonImage = ({
  ...
  <div
    className="flex h-dvh w-full shrink-0 items-center justify-center p-16"
    key={reason.id}
  >
  ...
  return (
    ...
    >
      ...
      >
        {/* Left text panel */}
        <div
          className={`flex h-dvh flex-col items-start justify-start pt-24 md:pt-32 lg:pt-40 ${showImagePanel ? "w-full md:w-1/2" : "max-w-4xl items-center text-center md:w-3/4"}`}
        >
