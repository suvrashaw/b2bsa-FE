...
export const CorporateVideoIndustriesSection = ({
  ...
  return (
    <section className="relative overflow-hidden bg-[#111518] pt-20 pb-16 text-white md:pt-32 md:pb-20 lg:pt-52 lg:pb-24">
      ...
      <div className="relative z-10 container mx-auto max-w-screen-2xl px-4 md:px-6 lg:px-8">
        <div className="max-w-5xl">
          <SectionHeader as="h2" className="max-w-4xl leading-none text-white" level="h1">
            {heading}
          </SectionHeader>
          ...
          <div className="mt-8 max-w-4xl space-y-6 md:mt-10 md:space-y-7">
            {industries.map((industry) => (
              <article key={industry.title}>
                <h3 className="type-h3 leading-tight text-[#4BC0D9]">{industry.title}</h3>
