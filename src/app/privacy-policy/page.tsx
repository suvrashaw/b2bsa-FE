          ...
          <div className="prose prose-lg prose-slate max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 leading-relaxed text-gray-600">
                ...
                fill out a form, request a consultation, or contact us via
                email. This may include your name, email address, company name,
                and phone number.
              </p>
            </section>
            <section className="mb-12">
              ...
              <p className="mb-4 leading-relaxed text-gray-600">
                ...
                improve our services, to communicate with you about your
                projects, and to send you insights and updates that may be
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 leading-relaxed text-gray-600">
                ...
                choose to disable cookies in your browser settings, although
                this may affect the functionality of some parts of the site.
              </p>
            </section>
            <section className="mb-12">
              <SectionHeader
